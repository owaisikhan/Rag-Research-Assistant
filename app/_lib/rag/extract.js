 ...
 *
 * Separate from the file-path helper so an uploaded PDF never has to be
 * written to disk first -- serverless has no persistent filesystem, and a
 * temp file is one more thing to fail to clean up.
 *
